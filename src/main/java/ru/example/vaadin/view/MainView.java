package ru.example.vaadin.view;
...
import ru.example.vaadin.components.EmployeeEditor;
import ru.example.vaadin.domain.Employee;
import ru.example.vaadin.repo.EmployeeRepo;

@Route("")
class EmployeeList extends VerticalLayout {
